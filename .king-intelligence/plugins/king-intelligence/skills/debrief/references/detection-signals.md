...
A future meeting was named, AND/OR someone coached the user on how to approach a person or meeting. This is the classic meeting-prep pattern: a client spends six minutes telling the user exactly how to sell to a third party on Thursday. That is gold and the old skill would have logged "meeting Thursday" and dropped the entire playbook.
...
Not a "signal" to action, but capture it: retention risk, how they like to work, personal details, buying temperature, what's driving them. Feeds the summary's relationship section + memory. ("I'm out of time and can't hire" is often the whole reason a client buys — capture the real reason when it's said out loud.)
