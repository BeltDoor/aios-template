...
**Signals:**
- First-time meeting (no prior conversation history in the contact's notes)
...
- The contact explains their business, team, or tech stack for the first time

### coaching
**Display name:** Coaching Session
**Signals:**
- The contact is already paying for coaching (a per-session rate)
- Screen sharing, tool installation, demos of the user's tools
- Teaching/explaining concepts ("how this works", "let me show you")
...
**Signals:**
- The user showing a product
- "Let me show you" / "Here's how it works" / "Watch this"
- The contact reacting to features ("That's cool" / "How does that work?")
...
**Signals:**
- The contact has already signed up or paid
